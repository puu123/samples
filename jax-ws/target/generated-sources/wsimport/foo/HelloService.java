 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://foo/", wsdlLocation = "file:/C:/Users/motohashi/Documents/ws.jax-ws/jax-ws/target/generated-sources/wsdl/HelloService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://foo/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/motohashi/Documents/ws.jax-ws/jax-ws/target/generated-sources/wsdl/HelloService.wsdl");
    ...
    public HelloWorldService getHelloWorldServicePort() {
        return super.getPort(new QName("http://foo/", "HelloWorldServicePort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://foo/", "HelloWorldServicePort"), HelloWorldService.class, features);
    }
